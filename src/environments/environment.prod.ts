import { IEnvironment, Prod } from './types';

export const environment: IEnvironment = {
    production: true,
    environmentName: Prod.Production,
    basePath: "https://filmdizibulmaseysi.web.app/1",
    ...
    firebaseConfig: {
        ...
        appId: "1:814342677142:web:5eb5db2f6aebe9a8f7d8b7",
        measurementId: "G-3CZJCN8R26"
    }
};